...
__all__ = [
    ...
    'DISPID_SVGetAudioInputs', 'DISPID_SpeechObjectToken',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SDKEnumKeys',
    'SPAS_RUN', 'SDTReplacement', 'SRADefaultToActive', 'SGRSTTWord',
    'DISPID_SpeechPhraseProperty', 'DISPID_SGRSRule', 'SPEI_PHONEME',
    'SITooSlow', 'SpeechGrammarTagWildcard', 'DISPID_SPELexicalForm',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechObjectTokens',
    'DISPID_SPRuleId', 'DISPID_SPRuleFirstElement', 'DISPID_SAVolume',
    'SPSSuppressWord', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SpSharedRecoContext', 'SVEAllEvents', 'DISPID_SpeechLexicon',
    'SPEI_PHRASE_START', 'SECFIgnoreWidth',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpShortcut', 'SPEI_SOUND_END',
    'ISpEventSink', 'DISPID_SVAudioOutputStream',
    ...
    'DISPID_SBSRead', 'SAFTADPCM_11kHzMono', 'SREAdaptation',
    ...
    'DISPID_SRCVoice', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SpeechAudioBufferInfo', 'SREAllEvents',
    'SPEI_SENTENCE_BOUNDARY', 'SpShortcut', 'ISpeechObjectToken',
    'DISPID_SLPLangId', 'SRESoundEnd', 'eLEXTYPE_PRIVATE16',
    '__MIDL_IWinTypes_0009', 'SpVoice', 'SPEI_SR_RETAINEDAUDIO',
    'SSTTDictation', 'DISPID_SPEDisplayAttributes', 'DISPID_SLWType',
    'ISpObjectTokenCategory', 'STSF_LocalAppData',
    'DISPID_SOTDataKey', 'SDTLexicalForm', 'SASPause',
    'SRSEIsSpeaking', 'DISPID_SPRText', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGCmdLoadFromMemory', 'SVP_8', 'SVSFIsFilename',
    'ISpRecognizer3', 'DISPID_SGRSTPropertyId',
    'DISPID_SWFEFormatTag', 'DISPID_SRSetPropertyNumber',
    'DISPID_SpeechPhraseAlternate', 'SVSFPurgeBeforeSpeak',
    'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE6', 'SP_VISEME_1',
    'DISPID_SOTCSetId', 'SPEI_HYPOTHESIS', 'SAFT22kHz8BitStereo',
    ...
    'DISPID_SRGetRecognizers', 'SpNullPhoneConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPWORDPRONOUNCEABLE', 'DISPID_SMSADeviceId', 'DISPID_SOTId',
    'DISPID_SRRGetXMLResult', 'SRCS_Enabled', 'SECFIgnoreCase',
    'DISPID_SWFEBitsPerSample', 'SDTAll', 'DISPID_SASFreeBufferSpace',
    'DISPID_SVEStreamEnd', 'SGDisplay', 'SP_VISEME_11', 'SPAR_Medium',
    'eLEXTYPE_APP', 'SPDATAKEYLOCATION', 'DISPID_SVEventInterests',
    'DISPID_SLWPronunciations', 'IStream',
    'DISPID_SpeechPhraseReplacements', 'IInternetSecurityMgrSite',
    'SDA_No_Trailing_Space', 'SAFTExtendedAudioFormat',
    'DISPID_SRIsUISupported', 'DISPID_SPILanguageId',
    'SGRSTTTextBuffer', 'SAFT32kHz8BitMono', 'eLEXTYPE_RESERVED4',
    'DISPID_SVIsUISupported', 'DISPID_SPARecoResult',
    'DISPID_SRState', 'SPEI_RESERVED3', 'ISpeechPhraseAlternates',
    'DISPID_SpeechGrammarRule', 'DISPID_SPEActualConfidence',
    ...
    'DISPIDSPTSI_SelectionOffset', 'SPEI_TTS_PRIVATE', 'SITooFast',
    'SAFT8kHz8BitMono', 'SDTAlternates', 'ISpeechRecoResult',
    'DISPID_SRGRecoContext', 'SP_VISEME_9', 'SpeechTokenKeyUI',
    'SpMMAudioOut', 'DISPID_SGRsCount', 'DISPID_SVSLastResult',
    'SWPUnknownWordPronounceable', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SPACommit', 'DISPID_SPPId', 'SPEI_PROPERTY_NUM_CHANGE',
    'SPEI_UNDEFINED', 'DISPID_SRRAudioFormat',
    'SpeechAudioFormatGUIDText', 'ISpeechBaseStream',
    'DISPID_SPCLangId', 'SPINTERFERENCE', 'SAFTText',
    'SAFT44kHz8BitStereo', 'ISpLexicon', 'DISPID_SpeechDataKey',
    'SVEAudioLevel', 'SVP_17',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SGRSTs_NewEnum',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPDKL_CurrentUser',
    'DISPID_SADefaultFormat', 'DISPID_SRCRequestedUIType',
    'SAFTADPCM_22kHzMono', 'DISPID_SGRSTransitions',
    'DISPID_SpeechLexiconWords', 'DISPID_SRRSaveToMemory',
    'DISPID_SpeechRecoResult', 'SPLOADOPTIONS', 'SVSFUnusedFlags',
    'DISPID_SRGDictationSetState', 'SpeechRetainedAudioOptions',
    'SPEI_REQUEST_UI', 'SPSHT_Unknown', 'SpeechEmulationCompareFlags',
    'SITooLoud', 'ISpeechLexicon', 'SVEVoiceChange',
    'DISPID_SRGRules', 'ISpRecoGrammar2', 'DISPID_SRDisplayUI',
    'SITooQuiet', 'DISPID_SpeechVoice', 'SVP_21', 'SVSFIsXML',
    'ISpRecoContext', 'DISPID_SGRsFindRule',
    'SpeechTokenKeyAttributes', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SAFSetWaveFormatEx', 'SPEI_WORD_BOUNDARY',
    'DISPID_SPIEnginePrivateData', 'SRTExtendableParse',
    'DISPID_SpeechCustomStream', 'SPLO_STATIC', 'SPEI_MAX_SR',
    'SPEI_RESERVED5', 'SPEI_SR_AUDIO_LEVEL', 'SPVOICESTATUS',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVSVisemeId',
    'DISPID_SGRSTPropertyName', 'SPXMLRESULTOPTIONS',
    'DISPID_SRGIsPronounceable', 'DISPID_SRStatus', 'SREInterference',
    'SP_VISEME_4', 'Speech_Max_Word_Length',
    'DISPID_SGRSTPropertyValue', 'SPGRAMMARWORDTYPE',
    'DISPID_SRCreateRecoContext', 'ISpRecoResult', 'SPCS_DISABLED',
    'SAFTNonStandardFormat', 'ISpStream', 'SAFT22kHz16BitStereo',
    'SDKLDefaultLocation', 'DISPID_SFSOpen', 'ISpSerializeState',
    'DISPID_SVAudioOutput', 'eLEXTYPE_LETTERTOSOUND',
    'ISpeechWaveFormatEx', 'ISpeechPhraseRule',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SMSGetData',
    'STSF_FlagCreate', 'SGRSTTEpsilon',
    'SpeechPropertyNormalConfidenceThreshold', 'SPVPRI_NORMAL',
    'DISPID_SMSALineId', 'DISPID_SGRSTText', 'SAFTNoAssignedFormat',
    'SAFTGSM610_44kHzMono', 'DISPID_SGRClear',
    'DISPID_SRCEPhraseStart', 'IEnumString', 'DISPID_SRIsShared',
    'SVP_4', 'ISpeechFileStream', 'DISPID_SRAudioInput',
    'SpeechVisemeType', 'DISPIDSPRG', 'SPEI_INTERFERENCE',
    'DISPID_SVStatus', 'SGLexical', 'SpeechTokenKeyFiles',
    'DISPID_SRCERequestUI', 'DISPID_SASState', 'DISPID_SPPs_NewEnum',
    'SPLO_DYNAMIC', 'ISpeechDataKey',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SDKOpenKey',
    'SPSMF_UPS', 'DISPID_SPPEngineConfidence', 'SPEI_START_SR_STREAM',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SPIRule',
    'DISPID_SPIStartTime', '_SPAUDIOSTATE', 'SP_VISEME_6',
    'ISpeechXMLRecoResult', 'DISPID_SRCESoundStart',
    'DISPID_SOTCDefault', 'ISpeechPhraseProperties', 'SASRun',
    'SPSEMANTICFORMAT', 'DISPID_SRGDictationUnload', 'SP_VISEME_7',
    'eLEXTYPE_MORPHOLOGY', 'SECNormalConfidence', 'SAFT48kHz8BitMono',
    'SREPropertyNumChange', 'DISPID_SABufferNotifySize',
    'DISPID_SVGetVoices', 'DISPID_SOTRemove', 'SGDSActive',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechRecoResultTimes', 'SpeechDisplayAttributes',
    'SpeechRegistryLocalMachineRoot', 'SVP_6', 'SVP_20', 'SPBO_AHEAD',
    'SPSTREAMFORMATTYPE', 'eLEXTYPE_PRIVATE5', 'SAFTADPCM_8kHzMono',
    'ISpeechObjectTokenCategory', 'ISpeechGrammarRules',
    'SPPS_RESERVED2', 'SpInprocRecognizer', 'SVEPrivate',
    'SGDSInactive', 'SPPHRASEREPLACEMENT', 'DISPID_SPRs_NewEnum',
    'DISPID_SPIGrammarId', 'ISpNotifySource',
    'DISPID_SPEAudioSizeBytes', 'SpNotifyTranslator',
    'SAFT12kHz16BitStereo', 'DISPID_SVGetProfiles', 'SpWaveFormatEx',
    'SVPNormal', 'DISPID_SRSCurrentStreamNumber', 'SPSHORTCUTTYPE',
    'SAFT16kHz8BitStereo', 'DISPID_SPEEngineConfidence',
    'SVSFNLPSpeakPunc', 'eLEXTYPE_PRIVATE2', 'SpeechTokenContext',
    'eLEXTYPE_PRIVATE15', 'SVP_7', 'DISPID_SDKGetStringValue',
    'SP_VISEME_0', 'SpUnCompressedLexicon', 'SAFT12kHz16BitMono',
    'SPAUDIOBUFFERINFO', 'DISPID_SLGetWords', 'SECFDefault',
    'DISPID_SBSFormat', 'SP_VISEME_19', 'DISPID_SRCEHypothesis',
    'SPEI_RECO_STATE_CHANGE', 'SPPS_Verb', 'DISPID_SRGReset',
    'DISPID_SAEventHandle', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SAFT11kHz16BitStereo',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SGRSTTDictation', 'SAFT11kHz8BitMono', 'SSFMCreate',
    'SPRST_INACTIVE', 'SPINTERFERENCE_TOOQUIET', 'DISPID_SLPsItem',
    'SpeechWordPronounceable', 'SpInProcRecoContext', 'SVF_Emphasis',
    'DISPID_SPPFirstElement', 'SPVISEMES', 'DISPID_SVEEnginePrivate',
    'SVSFParseSapi', 'DISPID_SPRulesCount', 'SPPS_Noun',
    'SPSInterjection', 'SPINTERFERENCE_NONE', 'SPBO_PAUSE', 'STCAll',
    'DISPID_SVRate', 'SpObjectToken', 'ISpeechRecoResultDispatch',
    'STSF_AppData', 'SVF_None', 'SpPhraseInfoBuilder',
    'SPEI_RESERVED6', 'STCInprocHandler', 'DISPID_SOTDisplayUI',
    'DISPID_SOTSetId', 'SPCT_SUB_DICTATION', 'SFTInput',
    'SP_VISEME_10', 'SVP_13', 'SpPhoneConverter', 'SPAS_STOP',
    'SPEVENTSOURCEINFO', 'SAFT24kHz8BitStereo', 'eWORDTYPE_ADDED',
    'DISPID_SOTGetDescription', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE18', 'SREPhraseStart', 'SPEVENTENUM',
    'SPPS_NotOverriden', 'SRAORetainAudio', 'SPVPRIORITY',
    'SDTDisplayText', 'SVP_18', 'SAFTCCITT_uLaw_8kHzMono',
    'eLEXTYPE_PRIVATE19', 'DISPID_SPRFirstElement', 'SPSFunction',
    'DISPID_SPPsCount', 'DISPID_SVPause', 'SAFT16kHz16BitStereo',
    'SRATopLevel', 'SpeechRuleAttributes', 'DISPID_SPRsCount',
    'DISPID_SRRSetTextFeedback', 'DISPID_SVEBookmark',
    'SPLEXICONTYPE', 'SpeechBookmarkOptions', 'SAFT32kHz8BitStereo',
    'ISpeechPhraseRules', 'DISPID_SRGId', 'DISPID_SpeechGrammarRules',
    'SRTAutopause', 'DISPID_SGRsDynamic', 'DISPID_SAStatus',
    'SAFT8kHz8BitStereo', 'SpStream', 'SPEI_SR_BOOKMARK',
    'SPGS_EXCLUSIVE', 'SPWORDPRONUNCIATIONLIST', 'SpMMAudioIn',
    'DISPID_SRRSpeakAudio', 'SpCompressedLexicon', 'SPWF_SRENGINE',
    'SPRULE', 'SPCT_COMMAND', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SABufferInfo', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SpeechGrammarRuleState', 'STCLocalServer', 'SRTEmulated',
    'ISpResourceManager', 'DISPID_SpeechRecognizer', 'SRTSMLTimeout',
    'SAFTGSM610_8kHzMono', 'DISPID_SRRTimes', 'UINT_PTR',
    ...
    'STSF_CommonAppData', 'Speech_Default_Weight', 'SSTTTextBuffer',
    'ISpPhraseAlt', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SRCState', 'DISPID_SpeechPhraseProperties',
    'SPSERIALIZEDRESULT', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SRCERecognizerStateChange', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPWT_PRONUNCIATION', 'ISpGrammarBuilder',
    'DISPID_SRCEInterference', 'SpLexicon', 'DISPID_SVSLastBookmark',
    'SPEI_END_SR_STREAM', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRProfile', 'SGPronounciation', 'SDTPronunciation',
    'DISPID_SpeechPhraseBuilder', 'SpeechEngineConfidence',
    'ISpeechRecoContext', 'SDKLCurrentConfig',
    'DISPID_SWFEBlockAlign', 'SREBookmark', 'SPGRAMMARSTATE',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPAsCount',
    'DISPID_SAFType', 'DISPID_SRRDiscardResultInfo', 'SP_VISEME_21',
    'SAFT11kHz16BitMono', 'SpeechEngineProperties',
    'DISPID_SRCEAudioLevel', 'SWPUnknownWordUnpronounceable',
    'DISPID_SVSpeak', 'ISpAudio', 'eLEXTYPE_USER',
    'DISPID_SRSNumberOfActiveRules', 'SPEI_SOUND_START',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRGCmdSetRuleState',
    'SPINTERFERENCE_LATENCY_WARNING', 'SP_VISEME_16', 'SVP_1',
    'DISPID_SPEs_NewEnum', 'ISpObjectWithToken', 'eLEXTYPE_RESERVED9',
    'SP_VISEME_18', 'SpeechRuleState', 'SVESentenceBoundary',
    'DISPID_SDKSetBinaryValue', 'ISequentialStream',
    'DISPID_SPAPhraseInfo', 'SVP_14', 'SAFT12kHz8BitStereo',
    'DISPID_SOTRemoveStorageFileName', 'SPBO_NONE',
    'eLEXTYPE_PRIVATE12', 'DISPID_SRCCreateGrammar',
    'DISPID_SVSInputSentencePosition', 'DISPID_SVEViseme',
    'DISPID_SGRSTRule', 'DISPID_SVEPhoneme', 'SpeechRecoEvents',
    'SRSActive', 'DISPID_SRCBookmark', 'ISpeechMMSysAudio',
    'DISPID_SPERequiredConfidence', 'DISPID_SRGCmdLoadFromObject',
    'SPFM_CREATE', 'DISPID_SOTGetStorageFileName', 'DISPID_SLWWord',
    'SLTUser', 'DISPID_SPERetainedSizeBytes', 'SpeechStreamFileMode',
    'DISPID_SVEWord', 'SAFT32kHz16BitStereo',
    'DISPID_SPEPronunciation', 'SpeechGrammarTagDictation',
    'DISPID_SpeechPhraseReplacement', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPCT_DICTATION', 'SPEI_FALSE_RECOGNITION', 'IEnumSpObjectTokens',
    'DISPID_SBSSeek', 'DISPID_SRCEEnginePrivate', 'SRSActiveAlways',
    'ISpeechRecoGrammar', 'SPWORDPRONUNCIATION',
    'SpeechVoiceCategoryTTSRate', 'SpMMAudioEnum',
    'SPINTERFERENCE_TOOSLOW', 'SPRECOSTATE',
    'DISPID_SVSCurrentStreamNumber', 'SVEStartInputStream',
    'SPAS_CLOSED', 'DISPID_SVESentenceBoundary',
    'SpeechAddRemoveWord', 'SPWORD', 'SBONone',
    'SSSPTRelativeToCurrentPosition', 'SPWORDLIST',
    ...
    'SpeechCategoryRecognizers', 'SPWT_LEXICAL',
    'SpeechPropertyAdaptationOn', 'SDA_One_Trailing_Space',
    'SRSEDone', 'DISPID_SVPriority', 'SVP_11', 'SVSFDefault',
    'SAFT44kHz16BitStereo', 'SVSFVoiceMask', 'DISPID_SPPChildren',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPSLMA',
    'SpeechCategoryAppLexicons', 'SAFT11kHz8BitStereo',
    'DISPID_SGRSTsItem', 'DISPID_SPRulesItem', 'SpeechUserTraining',
    'WAVEFORMATEX', 'SSTTWildcard', 'SDKLCurrentUser',
    'DISPID_SVSRunningState', 'ISpeechTextSelectionInformation',
    'SPAUDIOSTATE', 'DISPID_SGRsAdd', 'SpeechRecognitionType',
    'SPBOOKMARKOPTIONS', 'SPEI_END_INPUT_STREAM',
    'SAFTCCITT_uLaw_11kHzMono', 'SPPHRASERULE', 'DISPID_SFSClose',
    '_ISpeechVoiceEvents', 'SPPS_RESERVED3', 'ISpeechAudioFormat',
    'DISPID_SVSInputWordLength', 'DISPID_SPRuleParent',
    'SAFT24kHz16BitStereo', 'SRAInterpreter', 'DISPID_SGRId',
    'LONG_PTR', 'ISpeechRecognizer', 'SPPS_Noncontent',
    'DISPID_SRCPause', 'SSFMCreateForWrite', 'DISPID_SRRTTickCount',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechAudio', 'eLEXTYPE_RESERVED7',
    'SpeechRecoProfileProperties', 'SPPS_SuppressWord', 'SPVPRI_OVER',
    'SVP_19', 'SPSHT_OTHER', 'SPSVerb', 'SpeechVoiceEvents',
    'SREStateChange', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVEViseme',
    'DISPID_SpeechVoiceStatus', 'SASStop', 'SVEPhoneme',
    'DISPID_SPAsItem', 'DISPID_SRGCommit', 'SPPS_Modifier',
    'DISPID_SRCRetainedAudioFormat', 'SDTAudio',
    'DISPID_SVSpeakCompleteEvent', 'SPEI_RECO_OTHER_CONTEXT',
    'SP_VISEME_2', 'tagSPTEXTSELECTIONINFO',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLPsCount', 'SPFILEMODE',
    'DISPID_SLGetGenerationChange', 'SVP_15', 'DISPID_SRRAudio',
    'DISPID_SpeechXMLRecoResult', 'SDTRule', 'ISpNotifyTranslator',
    'SpeechDictationTopicSpelling', 'DISPID_SGRSTType',
    'SpeechSpecialTransitionType', 'ISpProperties',
    'SpeechRegistryUserRoot', 'ISpeechMemoryStream',
    'ISpRecoContext2', 'SPSEMANTICERRORINFO',
    'SGLexicalNoSpecialChars', 'DISPID_SVSLastBookmarkId',
    'SREPrivate', 'SPEI_MAX_TTS', 'SAFT8kHz16BitStereo',
    'SPFM_OPEN_READWRITE', 'SGSEnabled', 'ISpeechRecognizerStatus',
    'DISPID_SVSpeakStream', 'SREStreamStart',
    'DISPID_SPIReplacements', 'DISPID_SRRRecoContext',
    'ISpRecognizer', 'DISPID_SVSInputSentenceLength',
    'DISPID_SpeechLexiconWord', 'ISpeechLexiconPronunciations',
    'eLEXTYPE_PRIVATE8', 'SpeechVoiceSpeakFlags',
    'DISPID_SpeechPhraseInfo', 'SAFTCCITT_ALaw_44kHzMono',
    'SDA_Consume_Leading_Spaces', 'DISPID_SpeechAudioFormat',
    'SGSExclusive', 'SPAR_High', 'SLODynamic',
    'DISPID_SRGSetTextSelection', 'eLEXTYPE_VENDORLEXICON',
    'SRESoundStart', 'SP_VISEME_13', 'eLEXTYPE_PRIVATE11',
    'SpeechAudioFormatType', 'ISpeechPhraseAlternate', 'SBOPause',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRCEEndStream', 'SP_VISEME_5',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPTEXTSELECTIONINFO',
    'DISPID_SVSkip', 'DISPID_SPRules_NewEnum', 'ISpRecoCategory',
    'ISpeechPhraseInfo', 'DISPID_SVEAudioLevel', 'SSSPTRelativeToEnd',
    'SPPS_Unknown', 'SDA_Two_Trailing_Spaces', 'SVEWordBoundary',
    'SPWORDTYPE', 'DISPID_SGRName', 'DISPID_SRRTLength',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPIAudioStreamPosition',
    'ISpeechVoice', 'SRERecognition', 'SPEI_MIN_SR',
    'ISpeechLexiconWord', 'SECLowConfidence', 'SPADAPTATIONRELEVANCE',
    'SpStreamFormatConverter', 'SVP_12', 'SAFT12kHz8BitMono',
    'DISPID_SWFESamplesPerSec', 'SpeechAllElements', 'SpCustomStream',
    'DISPID_SPCPhoneToId', 'DISPID_SAFGuid', 'DISPID_SDKDeleteValue',
    'eLEXTYPE_PRIVATE1', 'SVPOver', 'SWPKnownWordPronounceable',
    'SPEI_RESERVED1', 'SPSNoun', 'SpeechFormatType', 'SP_VISEME_15',
    'DISPID_SRSetPropertyString', 'DISPID_SLPPhoneIds',
    'SpeechDataKeyLocation', 'DISPID_SRGetFormat', 'SPBINARYGRAMMAR',
    'SPVPRI_ALERT', 'DISPID_SPIAudioSizeBytes', 'SPPROPERTYINFO',
    ...
    'eWORDTYPE_DELETED', 'DISPID_SPPName', 'eLEXTYPE_PRIVATE10',
    'SRAImport', 'DISPID_SLWs_NewEnum', 'DISPID_SOTsItem',
    'DISPID_SRRTStreamTime', 'ISpeechGrammarRule', 'SINone',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRGDictationLoad', 'SASClosed',
    'SpeechPartOfSpeech', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SPEDisplayText', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPRsItem', 'SDKLLocalMachine',
    'DISPID_SPERetainedStreamOffset', 'SPPS_RESERVED1', 'SPRULESTATE',
    ...
    'DISPID_SRCResume', '_RemotableHandle', 'DISPID_SPEsItem',
    'ISpeechLexiconWords', 'DISPID_SpeechWaveFormatEx', 'SP_VISEME_8',
    'DISPID_SRCRetainedAudio', 'ISpeechGrammarRuleStateTransition',
    'SFTSREngine', 'ISpeechResourceLoader', 'SPEI_RESERVED2',
    'ISpeechVoiceStatus', 'DISPID_SVVoice', 'SPRECORESULTTIMES',
    'Speech_StreamPos_Asap', 'ISpStreamFormatConverter',
    'SpeechGrammarWordType', 'eLEXTYPE_PRIVATE3', 'SPEI_SR_PRIVATE',
    'SVP_16', 'DISPID_SVVolume', 'SpeechLoadOption',
    'ISpeechPhraseElements', 'DISPID_SpeechMemoryStream', 'SVP_0',
    'SPAO_RETAIN_AUDIO', 'DISPID_SpeechPhraseElements',
    'DISPID_SRGetPropertyNumber', 'SECFNoSpecialChars',
    'SPCS_ENABLED', 'SP_VISEME_12', 'SRSInactiveWithPurge',
    'SVSFParseSsml', 'DISPID_SOTIsUISupported', 'DISPID_SDKDeleteKey',
    'ISpeechRecoResult2', 'SpFileStream', 'SSFMOpenForRead',
    'DISPID_SLPType', 'ISpeechGrammarRuleState', 'SPEI_VISEME',
    'SPRECOGNIZERSTATUS', 'SGDSActiveUserDelimited',
    'DISPID_SPEAudioTimeOffset', 'ISpeechPhoneConverter',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SAFT24kHz8BitMono',
    'SLOStatic', 'Speech_Max_Pron_Length', 'SAFTADPCM_44kHzMono',
    'DISPID_SRGState', 'SPXRO_SML', 'SPCT_SUB_COMMAND',
    'SSFMOpenReadWrite', 'DISPID_SPRNumberOfElements', 'SVP_3',
    'SVP_5', 'DISPID_SRCEStartStream', 'SpeechVisemeFeature',
    'SpPhoneticAlphabetConverter', 'SLTApp', 'SAFTGSM610_11kHzMono',
    'SAFTDefault', 'DISPID_SVEVoiceChange', 'SRAExport',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechLexiconProns',
    'DISPIDSPTSI', 'SPPHRASEELEMENT', 'SAFT32kHz16BitMono',
    ...
    'SpeechAudioVolume', 'SPCATEGORYTYPE', 'SPDKL_LocalMachine',
    'SRERequestUI', 'SAFT16kHz16BitMono', 'SpeechRunState',
    'tagSTATSTG', 'DISPID_SRGSetWordSequenceData', 'ISpMMSysAudio',
    'SGRSTTWildcard', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SVWaitUntilDone', 'SpeechVoicePriority',
    'DISPID_SMSAMMHandle', 'SINoise',
    'SpeechPropertyLowConfidenceThreshold', 'SP_VISEME_14',
    'SPWF_INPUT', 'DISPID_SPPNumberOfElements', 'SREFalseRecognition',
    'DISPID_SRGCmdLoadFromFile', 'eLEXTYPE_RESERVED10',
    'SPEI_ADAPTATION', 'SPEI_START_INPUT_STREAM',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPBO_TIME_UNITS',
    '_ISpeechRecoContextEvents', 'DISPID_SGRAddState', 'SPWT_DISPLAY',
    'SpeechCategoryAudioOut', 'SPSHORTCUTPAIR',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPIEngineId', 'SVP_10',
    'DISPID_SASCurrentSeekPosition', 'ISpRecognizer2',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SpeechMMSysAudio',
    'DISPID_SVSLastStreamNumberQueued', 'SPSERIALIZEDPHRASE',
    'DISPID_SOTCGetDataKey', 'SPAS_PAUSE', 'SAFTADPCM_11kHzStereo',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SRAudioInputStream',
    'SPAR_Unknown', 'ISpXMLRecoResult', 'DISPID_SVSInputWordPosition',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpNotifySink', 'SpeechAudioState',
    'SREAudioLevel', 'DISPID_SLGetPronunciations',
    'IInternetSecurityManager', 'SAFT44kHz8BitMono',
    'DISPID_SWFEChannels', 'SPPS_RESERVED4',
    'DISPID_SRCEventInterests', 'SpeechDiscardType',
    'DISPID_SRCEPropertyNumberChange', 'SpAudioFormat',
    'DISPID_SLWsCount', 'SPPS_LMA', 'SpeechInterference',
    'ISpPhoneticAlphabetConverter', 'ISpeechLexiconPronunciation',
    'DISPID_SPRuleConfidence', 'SVEBookmark', 'eLEXTYPE_PRIVATE9',
    'DISPID_SPPParent', 'ISpeechPhraseProperty', 'SpSharedRecognizer',
    'DISPID_SPAStartElementInResult', 'DISPID_SPEAudioSizeTime',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SpeechFileStream',
    'ISpeechGrammarRuleStateTransitions', 'SpResourceManager',
    'SVSFNLPMask', 'SDTProperty', 'DISPID_SGRs_NewEnum',
    'SRCS_Disabled', 'SRTReSent', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SRTStandard',
    'SpeechRecoContextState', 'SPPS_Interjection', 'SGSDisabled',
    'DISPID_SPIAudioSizeTime', 'ISpeechObjectTokens',
    'DISPID_SOTsCount', 'SRADynamic', 'ISpPhrase',
    'SpeechMicTraining', 'SPCONTEXTSTATE', 'DISPID_SOTs_NewEnum',
    'SPAR_Low', 'SPPHRASE', 'SPFM_OPEN_READONLY', 'STCInprocServer',
    'DISPID_SLGenerationId', 'SPCT_SLEEP', 'SVSFPersistXML',
    'SPPS_Function', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SDKGetlongValue', 'ISpeechRecoResultTimes',
    'SpeechPropertyHighConfidenceThreshold', 'SVSFlagsAsync',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSHT_EMAIL',
    'DISPID_SPIGetText', 'SPDKL_CurrentConfig', 'SRARoot',
    'SpTextSelectionInformation', 'DISPID_SpeechPhraseElement',
    'SPGS_ENABLED', 'DISPID_SABIEventBias', 'eLEXTYPE_RESERVED8',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPDKL_DefaultLocation',
    'DISPID_SVDisplayUI', 'DISPID_SPCIdToPhone',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SRRTOffsetFromStart',
    'ISpeechPhraseInfoBuilder', 'DISPID_SLPSymbolic', 'SWTDeleted',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_PRIVATE17',
    'SpObjectTokenCategory', 'SPEI_MIN_TTS', 'DISPID_SVSPhonemeId',
    'DISPID_SPPValue', 'SRSInactive', 'SpeechPropertyResponseSpeed',
    'SpeechVoiceSkipTypeSentence', 'SSSPTRelativeToStart',
    'DISPID_SPPConfidence', 'DISPID_SVResume', 'SPWAVEFORMATTYPE',
    'SPGS_DISABLED', 'SPEI_TTS_BOOKMARK', 'ISpPhoneConverter',
    'DISPID_SPEsCount', 'DISPID_SpeechObjectTokenCategory',
    'SpeechWordType', 'DISPID_SRRAlternates', 'SPEI_RECOGNITION',
    'DISPID_SPAs_NewEnum', 'SECHighConfidence', 'DISPID_SGRSTsCount',
    'SPSModifier', 'eLEXTYPE_PRIVATE20', 'SVPAlert', 'SINoSignal',
    'DISPID_SVGetAudioOutputs', 'SPXRO_Alternates_SML',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SVSFIsNotXML',
    'SpeechStreamSeekPositionType', 'SpeechAudioProperties',
    'SAFT48kHz16BitMono', 'ISpRecoGrammar',
    'DISPID_SPRDisplayAttributes', 'SPRST_ACTIVE',
    'DISPID_SPIRetainedSizeBytes', 'tagSPPROPERTYINFO',
    'SPPARTOFSPEECH', 'SPRS_ACTIVE', 'DISPID_SpeechAudio',
    ...
    'SP_VISEME_3', 'DISPID_SRSAudioStatus', 'ISpVoice',
    ...
    'DISPID_SRGetPropertyString', 'SAFTADPCM_44kHzStereo',
    'SPSUnknown', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SRRecognizer',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIElements', 'ISpDataKey',
    ...
    'SAFTCCITT_uLaw_8kHzStereo', 'SPAUDIOSTATUS',
    'SpeechCategoryVoices', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SLWsItem', 'SWTAdded', 'eLEXTYPE_PRIVATE4',
    'DISPID_SRRPhraseInfo', 'SPRS_INACTIVE',
    'DISPIDSPTSI_ActiveLength', 'SVF_Stressed',
    'SpeechTokenShellFolder', 'SREHypothesis',
    'DISPID_SPRuleChildren', 'DISPID_SREmulateRecognition',
    'SVEEndInputStream', 'DISPID_SPIProperties',
    'SAFTGSM610_22kHzMono', 'SpeechGrammarState', 'SP_VISEME_17',
    'SpMemoryStream', 'DISPID_SpeechVoiceEvent',
    'DISPID_SGRAttributes', 'DISPID_SRCERecognition', 'SVP_9',
    'ISpObjectToken', 'SPEVENT', 'DISPID_SpeechRecognizerStatus',
    'SPSHT_NotOverriden', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPRuleName', 'DISPID_SOTCId',
    'DISPID_SDKCreateKey', 'ISpPhoneticAlphabetSelection',
    'DISPID_SWFEExtraData', 'DISPID_SGRsCommit', 'SPFM_NUM_MODES',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SPRuleNumberOfElements', 'SAFT8kHz16BitMono',
    'DISPID_SASetState', 'SVP_2', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_RESERVED6', 'SpeechTokenValueCLSID', 'SP_VISEME_20',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SGRsItem', 'SRAONone',
    'DISPID_SCSBaseStream', 'SpeechLexiconType',
    'DISPID_SRCRecognizer', 'SAFT22kHz16BitMono', 'SPAO_NONE',
    'DISPID_SDKEnumValues', 'SPEI_VOICE_CHANGE',
    'DISPID_SLRemovePronunciation', 'SECFEmulateResult',
    'SRERecoOtherContext', 'SGDSActiveWithAutoPause', 'SGRSTTRule'
]
